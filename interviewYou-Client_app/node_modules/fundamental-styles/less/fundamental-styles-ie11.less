...
.fd-button-group .fd-dropdown__control.fd-button:active,
.fd-button-group .fd-dropdown__control.fd-button:hover,
.fd-button-group .fd-dropdown__control.is-active.fd-button,
.fd-button-group .fd-dropdown__control.is-active[class*=fd-button--],
.fd-button-group .fd-dropdown__control:active[class*=fd-button--],
.fd-button-group .fd-dropdown__control:hover[class*=fd-button--],
...
.fd-button-group .fd-dropdown__control[class*=fd-button--]::after,
...
.fd-button-group .fd-dropdown__control[dir=rtl][class*=fd-button--],
.fd-button-group [dir=rtl] .fd-dropdown__control.fd-button,
.fd-button-group [dir=rtl] .fd-dropdown__control[class*=fd-button--],
.fd-dropdown__control.fd-button--standard[dir=rtl],
[dir=rtl] .fd-button-group .fd-dropdown__control.fd-button,
[dir=rtl] .fd-button-group .fd-dropdown__control[class*=fd-button--],
...
.fd-table .fd-table__fixed-col {
  -webkit-box-shadow: 2px 0 0 0 #eeeeef;
...
.fd-calendar .fd-calendar__header {
  -webkit-box-shadow: inset 0 -1px 0 0 #eeeeef;
...
.fd-popover__body {
  ...
  background-color: #fff;
  background-color: var(--fd-color-background-2);
  -webkit-box-shadow: 0 5px 20px 0 #d9d9d9,0 2px 8px 0 #eeeeef;
  box-shadow: 0 5px 20px 0 #d9d9d9,0 2px 8px 0 #eeeeef;
...
.fd-date-picker .fd-popover__popper {
  padding: 0 12px
}
.fd-time {
  width: 184px
...
.fd-has-background-color-accent-10 {
  background-color: #5c819d!important;
